...
- Copy the folder "public" and all files in it to your web sever.
...
- For security reasons: configure a vhost or an alias that has defined the "public" folder as it's root web folder.
