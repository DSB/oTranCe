...
// binota (61), DSB (170
$lang = array(
'L_ACCOUNT_ACTIVATED' => '您用於工程 %2$s 的使用者帳戶 %1$s 已由管理員啟動',
'L_ACCOUNT_ACTIVATED_SUBJECT' => 'User account %1$s for %2$s activated',
'L_ACCOUNT_OF_USER_WITH_ID' => '编辑 %s 的用户账户',
...
'L_CHANGE_RIGHT' => 'Change right'修改权限',
'L_CHANGE_STATUS' => 'Change status',
'L_CHANGE_YOUR_PASSWORD' => 'Change the password of your user-account:HARS' => 'Check character set!',
...
'L_CONFIGURATION' => '組態',
'L_CONConfigurationELETE_FILE_TEMPLATE' => 'Are you sure, that you want to delete the file template',
'L_CONFIRM_DELETE_KEY_X' => '您確定要刪Are you sure you want to delete the key \'{KEY}\'?ELETE_LANGUAGE' => 'Are you really sure you want to delete this language?<br />This will also remove all translations, all log entries and all edit rights of users for this language.',
'L_CONFIRM_DELETE_LANGUAGE_BUTTON' => '沒問題，刪Yes, delete language',
'L_CONFIRM_DELETE_LOG_ENTRY' => 'Are you really sure you want to delete this log entry?',
'L_CONFIRM_DELETE_TITLE' => 'Really delete?ELETE_USER' => 'Yes, delete user',
'L_CONFIRM_DELETE_VCS_CREDENTIALS' => 'Confirm deletion of VCS credentials',
'L_CONFIRM_PASSWORD' => 'Confirm password',
'L_CONFIRM_PASSWORD_EXPLAIN' => '要修改密碼Enter a password if you want to change it. If you leave this field empty the current password will remain.MAIL' => 'General contact e-mail address',
'L_CONTENT_IS_THE_SAME_AS_IN_FALLBACK_LANGUAGE' => 'The content is the same as in the main language and was not imported!',
'L_CONVERT' => 'Convert',
'L_CONVERT_CHARS_FROM' => '转换字符',
'L_COPY_TO' => 'Copy to',
...
'L_LOG' => 'Log',
'L_LOGIN' => 'Login',
'L_LOGIN_A登录GIN' => 'Automatic login',
