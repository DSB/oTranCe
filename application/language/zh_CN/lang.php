...
$lang = array(
'L_ACCOUNT_ACTIVATED' => '您的使用者帳戶已由管理員啟動Your user account %1$s for the project %2$s has been activated by an administrator.',
'L_ACCOUNT_ACTIVATED_SUBJECT' => '%2$s 已啟動使用者帳戶 %1$s',
'L_ACCOUNT_OF_USER_WITH_ID' => '编辑 %s 的用户账户',
'L_ACCOUNT_SETTINGS' => '帳號設定',
'L_ACTION' => '啟動',
'L_ACTIVITIES' => '激活',
'L_ADD' => '新增',
...
'L_CHANGE_YOUR_PASSWORD' => '修改您的帳戶的密碼：',
