...
'L_CONFIRM_DELETE_LANGUAGE' => '您確定要刪除該的語言嗎？<br />這將一併移除所有翻譯、條目與所有擁有編輯此語言權限的使用者。',
...
'L_EDIT_FILE_TEMPLATE_X' => '編輯模版檔案「%s」',
...
'L_ENTER_VCS_EXPLAIN' => '請至少要輸入您個人的VCS憑證的使用者名稱。',
