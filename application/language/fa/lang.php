...
'L_ACCOUNT_SETTINGS' => 'تنظیمات حساب کاربری',
'L_ACTION' => 'Action',
'L_ACTIVITIES' => 'عملیات',
'L_ADD' => 'اضافه کردن',
'L_ADD_ENTRY' => 'Add a new entry',
'L_ADD_FILE_TEMPLATE' => 'اضافه کردن فایل قالب',
'L_ADD_NEW_KEY' => 'اضافه کردن کلید جدید',
'L_ADD_NEW_LANGUAGE' => 'اضافه کردن زبان جدید',
'L_ADMIN' => 'مدیریت کل',
...
'L_CANCEL' => 'انصراف',
'L_CAN_EDIT' => 'Can edit',
'L_CHANGES_SAVED_SUCCESSFULLY' => 'تغییرات شما با موفقیت ذخیره شده است',
'L_CHANGE_PASSWORD' => 'تغییر رمز عبور',
'L_CHANGE_RIGHT' => 'Change right',
'L_CHANGE_STATUS' => 'تغییر وضعیت',
'L_CHANGE_YOUR_PASSWORD' => 'تغییر رمز عبور حساب کاربری شما :',
'L_CHECK_CHARS' => 'مجموعه کاراکتر را بررسی کنید !',
...
'L_CLICK_TO_EDIT_USER_ACCOUNT' => 'برای ویرایش حساب کاربر اینجا کلیک کنید',
'L_CLICK_TO_INLINE_EDIT' => 'برای ویرایش خطی کلیک کنید',
'L_CLICK_TO_LOG_IN' => 'Click here to login with your registered data.',
'L_COMMIT_MESSAGE' => 'Commit message',
'L_COMPLETE_VIEW' => 'نمایش کامل',
'L_CONFIGURATION' => 'پیکر بندی',
'L_CONFIGURATION_OF_EXTERNAL_SERVICE' => 'Options of external service',
'L_CONFIRM_DELETE_FILE_TEMPLATE' => 'آیا شما مطمئن هستید که می خواهید فایل قالب را پاک کنید؟',
...
'L_CONFIRM_DELETE_LANGUAGE_BUTTON' => 'بله، زبان را حذف کنید',
'L_CONFIRM_DELETE_LOG_ENTRY' => 'Are you really sure you want to delete this log entry?',
'L_CONFIRM_DELETE_TITLE' => 'آیا شما مطمئن هستید ؟',
'L_CONFIRM_DELETE_USER' => 'بله، کاربر را حذف کنید',
'L_CONFIRM_DELETE_VCS_CREDENTIALS' => 'Confirm deletion of VCS credentials',
'L_CONFIRM_PASSWORD' => 'تکرار رمز عبور',
...
'L_CONTACT_EMAIL' => 'تماس عمومی از طریق آدرس ایمیل',
'L_CONTENT_IS_THE_SAME_AS_IN_FALLBACK_LANGUAGE' => 'The content is the same as in the main language and was not imported!',
'L_CONVERT' => 'تبدیل',
'L_CONVERT_CHARS_FROM' => 'تبدیل کاراکتر ها از',
'L_COPY_TO' => 'کپی کنید به',
'L_CREATED_ON_X_AT_Y' => 'Created on %1$s at %2$s.',
'L_CREATE_NEW_FILE_TEMPLATE' => 'ایجاد یک فایل قالب جدید',
'L_CREATE_NEW_USER_ACCOUNT' => 'ایجاد حساب کاربری جدید',
...
'L_DATETIME' => 'تاریخ / زمان',
'L_DELETE' => 'حذف',
'L_DELETE_CREDENTIALS' => 'Delete credentials',
'L_DELETE_FILE_TEMPLATE' => 'حذف فایل قالب',
'L_DELETE_FLAG' => 'حذف پرچم',
'L_DELETE_KEY' => 'حذف کلید',
'L_DELETE_LANGUAGE' => 'حذف زبان',
'L_DELETE_LOG_ENTRY' => 'Delete log entry',
'L_DELETE_USER' => 'حذف کاربر',
'L_DESCRIPTION' => 'Description',
'L_DONE' => 'انجام شده',
'L_DOWNLOAD' => 'دانلود',
'L_DOWNLOADS' => 'دانلودها',
'L_DOWNLOAD_OF_LANGUAGE_PACKS' => 'دانلود بسته های زبان',
...
'L_EDIT_FILE_TEMPLATE' => 'ویرایش فایل قالب',
'L_EDIT_FILE_TEMPLATE_X' => 'ویرایش فایل قالب \'%s\'',
'L_EDIT_LANGUAGE' => 'ویرایش زبان',
...
'L_ENTRIES_PER_PAGE' => 'نوشته ها در هر صفحه',
'L_ERROR' => 'خطا',
'L_ERRORS' => 'خطاها',
...
'L_ERROR_DELETING_FILE_TEMPLATE' => 'خطا در حذف فایل قالب',
'L_ERROR_DELETING_FLAG' => 'پرچم نمی تواند حذف شود',
'L_ERROR_DELETING_KEY' => 'خطا در حذف کلید',
'L_ERROR_DELETING_LANGUAGE' => 'در هنگام حذف این زبان خطایی به وجود آمده است<br />لطفا دوباره سعی کنید',
'L_ERROR_DELETING_USER' => 'خطایی در هنگام حذف این کاربر به وجود آمده است',
...
'L_ERROR_PERMISSION' => 'خطای دسترسی',
...
'L_EXPORT' => 'صادرات',
'L_EXPORT_BUILD_DOWNLOAD_PACKAGE' => 'ساخت پکیج دانلود',
'L_EXPORT_COMMITTOVCS' => 'Export to VCS',
'L_EXPORT_COMMIT_FILES_VCS' => 'Commit files to VCS',
'L_EXPORT_DOWNLOAD_PACKAGE_UPTODATE' => 'دانلود پکیج بروز شده است',
'L_EXPORT_EXPORTING_LANGUAGE' => 'صادرات زبان',
'L_EXPORT_FILE_STATUS_DOWNLOAD_PACKAGE' => 'وضعیت پکیج های دانلود:',
'L_EXPORT_LANGUAGES' => 'صادرات زبان ها',
...
'L_EXPORT_LATEST_CHANGE_DATABASE' => 'آخرین تغییر در پایگاه داده',
'L_EXPORT_LATEST_CHANGE_IN_DOWNLOAD_PACKAGE' => 'آخرین تغییر در پکیج دانلود؟',
'L_EXPORT_UPDATE_NEEDED' => 'دانلود پکیج بروز شده.',
'L_EXPORT_VCSERROR' => 'VCS Error',
'L_EXPORT_VCS_OUTPUT' => 'VCS output',
'L_FALLBACK_LANGUAGE' => 'زبان اصلی',
'L_FILE' => 'فایل',
'L_FILEBROWSER' => 'مرورگر فایل',
'L_FILECONTENT' => 'محتوای فایل %s',
'L_FILENAME' => 'نام فایل',
'L_FILESIZE' => 'حجم فایل',
'L_FILE_PATH' => 'مسیر فایل',
'L_FILE_TEMPLATE' => 'فایل قالب',
'L_FILE_TEMPLATES' => 'فایل قالب ها',
'L_FILE_TEMPLATE_DELETED_SUCCESSFULLY' => 'فایل قالب با موفقیت حذف شد.',
'L_FILE_TEMPLATE_SETTINGS' => 'تنظیمات فایل قالب',
...
'L_FIND_UNTRANSLATED' => 'جستجو کلید های ترجمه نشده در زبان',
'L_FLAG' => 'پرچم',
'L_FLAG_DELETED_SUCCESSFULLY' => 'پرچم با موفقیت حذف شد',
'L_FOOTER' => 'Footer',
'L_FOOTER_DONATE' => 'حمایت',
'L_FOOTER_EXPLAIN' => 'oTranCe is a free online translation platform',
'L_FOOTER_HOMEPAGE' => 'oTranCe صفحه اصلی',
'L_FOOTER_TEAM' => 'تیم توسعه دهنده',
...
'L_FORGOT_PASSWORD_RESET_PASSWORD' => 'تنظیم مجدد رمز عبور',
...
'L_FORGOT_PASSWORD_TITLE' => 'رمز عبور خود را فراموش کرده اید ؟',
'L_FORGOT_PASSWORD_UNKNOWN_USER' => 'این کاربر وجود ندارد.',
'L_FORGOT_PASSWORD_USERNAME_NOT_EXISTS' => 'The user "%s" does not exist!',
'L_FOUND_X_KEYS' => 'Found %s keys.',
'L_GENERAL' => 'عمومی',
'L_GENERATED_CONTENT' => 'محتوای تولید شده',
'L_GET_NEXT_UNTRANSLATED_KEY' => 'Find next untranslated key',
'L_GET_PREVIOUS_UNTRANSLATED_KEY' => 'Get last untranslated key',
'L_GOTO_FORGOT_PASSWORD_PAGE' => 'آیا رمز عبور خود را <a href="%s">فراموش</a> کرده ایید؟',
'L_GOTO_REGISTER_PAGE' => 'You don\'t have an account yet? You can <a href="%s">register</a> an account here.',
'L_HEADER' => 'Header',
'L_HEADER_EXPORT' => 'صادرات',
'L_HITS' => 'کل',
'L_HOME' => 'صفحه اصلی',
'L_ID' => 'Id',
'L_IMPORT' => 'واردات',
'L_IMPORTER' => 'وارد کننده',
'L_IMPORT_ANOTHER_FILE' => 'Import another file',
'L_IMPORT_DONE' => 'Congratulations.<br />
The importer has processed all entries.',
'L_IMPORT_SETTINGS' => 'تنظیمات واردات',
'L_IMPORT_STATUS' => 'وضعیت واردات',
'L_IMPORT_TO_DATABASE' => 'واردات به پایگاه داده',
'L_INTERFACE_LANGUAGE' => 'زبان رابط',
'L_IS_ACTIVE' => 'فعال است',
'L_KEY' => 'کلید',
'L_KEYS_PROCESSED' => 'Keys processed',
'L_KEYS_TOTAL' => 'تمام کلید ها',
