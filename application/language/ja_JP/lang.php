...
'L_ACCOUNT_ACTIVATED_SUBJECT' => '%2$sに%1$sというユーザーアカウントを有効にしました。',
'L_ACCOUNT_OF_USER_WITH_ID' => 'idが%sのユーザーのアカウントを編集',
'L_ACCOUNT_SETTINGS' => 'アカウントの設定',
'L_ACTION' => 'Action',
'L_ACTIVITIES' => '活動',
'L_ADD' => '追加',
'L_ADD_ENTRY' => '新しい項目を追加',
'L_ADD_FILE_TEMPLATE' => 'ファイルテンプレートを追加',
'L_ADD_NEW_KEY' => '新しいキーを追加',
'L_ADD_NEW_LANGUAGE' => '新しい言語を追加',
'L_ADMIN' => '管理者',
'L_ADMIN_RIGHTS' => '管理者権限',
'L_ADMIN_SELECT_TAB_EXPLAIN' => 'Select a section to edit by clicking on a tab in the head navigation.',
'L_ALSO_REMOVED_LOG_ENTRIES_SETTINGS_AND_RIGHTS' => 'すべてのログの項目、設定と権限も削除しました。',
'L_APIKEY' => 'APIキー',
'L_ARE_YOU_SURE_TO_DELETE_PERSONAL_VCS_CREDENTIALS' => '個人のバージョン管理システムの認証情報を本当に削除しますか?',
'L_AUTHENTICATE' => 'ログイン情報',
'L_AUTO_MAP_LOCALES' => 'ローケルを自動対応',
'L_BACK' => '戻る',
'L_BACK_TO_OVERVIEW' => '概要に戻る',
'L_CANCEL' => '取り止め',
'L_CAN_EDIT' => '編集可能',
'L_CHANGES_SAVED_SUCCESSFULLY' => '変更を保存しました。',
'L_CHANGE_PASSWORD' => 'パスワードを変更',
'L_CHANGE_RIGHT' => '権限を変更',
'L_CHANGE_STATUS' => '状態を変更',
'L_CHANGE_YOUR_PASSWORD' => 'Change the password of your user account:',
'L_CHECK_CHARS' => '文字集合を確認してください!',
...
'L_CLICK_TO_EDIT_USER_ACCOUNT' => 'クリックしてユーザーアカウントを編集',
'L_CLICK_TO_INLINE_EDIT' => 'Click to edit inline',
'L_CLICK_TO_LOG_IN' => 'クリックすると登録しているデータでログイン',
'L_COMMIT_MESSAGE' => 'コミットメッセージ',
'L_COMPLETE_VIEW' => 'Complete view',
'L_CONFIGURATION' => '構成',
'L_CONFIGURATION_OF_EXTERNAL_SERVICE' => '外部サービスのオプション',
'L_CONFIRM_DELETE_FILE_TEMPLATE' => 'このファイルテンプレートを本当に削除しますか?',
'L_CONFIRM_DELETE_KEY_X' => '\'{KEY}\'というキーを本当に削除しますか?',
'L_CONFIRM_DELETE_LANGUAGE' => 'この言語を本当に削除しますか?<br />実行するとすべての翻訳、すべてのログの項目、この言語のすべての編集の権限も削除します。',
'L_CONFIRM_DELETE_LANGUAGE_BUTTON' => 'はい、言語を削除します。',
'L_CONFIRM_DELETE_LOG_ENTRY' => 'このログの項目を本当に削除しますか?',
'L_CONFIRM_DELETE_TITLE' => 'Are you sure?',
'L_CONFIRM_DELETE_USER' => 'はい、ユーザーを削除します。',
'L_CONFIRM_DELETE_VCS_CREDENTIALS' => 'Confirm deletion of VCS credentials',
'L_CONFIRM_PASSWORD' => 'Confirm password',
'L_CONFIRM_PASSWORD_EXPLAIN' => '変更したい場合はパスワードを入力してください。現在のパスワードのままにする場合は、この欄を空のままにしてください。',
'L_CONNECTOR' => 'Connector',
'L_CONNECTOR_NO_HITS' => '翻訳するキーがないので何も送信しませんでした。',
...
'L_DELETE_FLAG' => 'フラッグを削除',
'L_DELETE_KEY' => 'キーを削除',
'L_DELETE_LANGUAGE' => '言語を削除',
'L_DELETE_LOG_ENTRY' => 'Delete log entry',
'L_DELETE_USER' => 'ユーザーを削除',
'L_DESCRIPTION' => '説明',
'L_DONE' => 'Done',
'L_DOWNLOAD' => 'ダウンロード',
'L_DOWNLOADS' => 'ダウンロード',
...
'L_HEADER' => 'ヘッダー',
'L_HEADER_EXPORT' => 'エクスポート',
'L_HITS' => '合計',
'L_HOME' => 'Home',
'L_ID' => 'Id',
'L_IMPORT' => 'インポート',
'L_IMPORTER' => 'Importer',
'L_IMPORT_ANOTHER_FILE' => '別のファイルをインポート',
...
'L_PREVIEW' => 'Preview',
'L_PREVIOUS_PAGE' => '前のページ',
'L_PROGRESS' => 'Progress',
'L_PROGRESS_OF_LANGUAGES' => 'Progress of translations',
'L_PROJECT' => 'プロジェクト',
'L_PROJECT_LOGO' => 'プロジェクトのロゴ',
'L_PROJECT_LOGO_EXPLAIN' => 'relative to project folder',
'L_PROJECT_NAME' => 'プロジェクトの名前',
'L_PROJECT_SETTINGS' => 'プロジェクトの設定',
'L_PROJECT_URL' => 'プロジェクトのURL',
...
'L_UNTRANSLATED' => '未翻訳',
'L_UPDATE_DOWNLOAD_PACKAGE' => '言語パッケージを更新',
