...
'L_ACCOUNT_SETTINGS' => 'Podešavanja korisničkog naloga',
'L_ACTION' => 'akcija',
'L_ACTIVITIES' => 'Aktivnosti',
'L_ADD' => 'dodati',
'L_ADDED' => 'dodao',
'L_ADD_ENTRY' => 'Dodavanje novog unosa',
'L_ADD_FILE_TEMPLATE' => 'Nova datoteka šablona',
'L_ADD_NEW_KEY' => 'Dodaj novi ključ',
'L_ADD_NEW_LANGUAGE' => 'Novi jezik',
'L_ADMIN' => 'admin',
'L_ADMIN_RIGHTS' => 'Administrator prava',
'L_ADMIN_SELECT_TAB_EXPLAIN' => 'Izaberite oblast za uređivanje klikom na kartici u gornjoj navigaci.',
'L_ALL_TRANSLATIONS_WILL_BE_DELETED_TOO' => 'Svi prevodi ovog tastera se takođe brišu',
'L_ALSO_REMOVED_LOG_ENTRIES_SETTINGS_AND_RIGHTS' => 'Sve stavke evidencije , podešavanja i prava takođe su uklonjene .',
'L_ARE_YOU_SURE_TO_DELETE_PERSONAL_VCS_CREDENTIALS' => 'Da li ste sigurni da želite da uklonite svoje lične podatke VCS ?',
'L_AUTHENTICATE' => 'Informacije o registraciji',
'L_BACK' => 'nazad',
'L_BACK_TO_OVERVIEW' => 'Nazad na pregled',
'L_CANCEL' => 'prekinuti',
'L_CAN_EDIT' => 'Može Edit',
'L_CHANGES_SAVED_SUCCESSFULLY' => 'Izmene su sačuvane',
'L_CHANGE_PASSWORD' => 'Promeni lozinku',
'L_CHANGE_RIGHT' => 'Zakon promene',
'L_CHANGE_STATUS' => 'statusna promena',
'L_CHANGE_YOUR_PASSWORD' => 'Promenite lozinku za vaš korisnički nalog :',
'L_CHECK_CHARS' => 'Charset proverite!',
'L_CHECK_CHARS_EXPLAIN' => 'Ako otkrijete bilo " čudno" znakove, možete da konvertujete datoteku na drugom setu karaktera <br />.
Izaberite font i kliknite na dugme "Convert likove iz" . Možete ponoviti postupak dok ispravi problem. Za svaku konverziju,original, otpremio datoteke se koristi kao baza . <br />
Kada indikator je dosledan , možete pokrenuti uvoz klikom na dugme " Start " analizu .',
'L_CLICK_TO_EDIT_USER_ACCOUNT' => 'Kliknite ovde da izmenite korisnički nalog',
'L_CLICK_TO_INLINE_EDIT' => 'Kliknite ovde da izmenite',
'L_CLICK_TO_LOG_IN' => 'Kliknite ovde da se registrujete sa snimljenim podacima.',
'L_COMMIT_MESSAGE' => 'Commit poruku',
'L_COMPLETE_VIEW' => 'Pun Pogledaj',
'L_CONFIGURATION' => 'konfiguracija',
'L_CONFIRM_DELETE_FILE_TEMPLATE' => 'Da li ste sigurni da želite da izbrišete ovaj šablon fajl',
'L_CONFIRM_DELETE_KEY_X' => 'Da li ste sigurni da želite da izbrišete ključ?',
'L_CONFIRM_DELETE_LANGUAGE' => 'Da li želite da izbrišete ovaj jezik <br /> Ovo takođe briše sve stavke evidencije i prava koriscenja korisnika za taj jezik.',
'L_CONFIRM_DELETE_LANGUAGE_BUTTON' => 'Da , brisanje jezika',
'L_CONFIRM_DELETE_LOG_ENTRY' => 'Da li želite da uklonite ovu stavku dnevnika ?',
'L_CONFIRM_DELETE_TITLE' => 'Stvarno obrisati ?',
'L_CONFIRM_DELETE_USER' => 'Da, izbriši korisnike',
'L_CONFIRM_DELETE_VCS_CREDENTIALS' => 'Potvrdite brisanje pristupa VCS',
...
'L_CONVERT_CHARS_FROM' => 'Konvertovan karakter od',
'L_COPY_TO' => 'Kopiraj u',
'L_CREATED_ON_X_AT_Y' => 'Created on %1$s at %2$s.',
'L_CREATE_NEW_FILE_TEMPLATE' => 'Napravi novi šablon datoteke',
'L_CREATE_NEW_USER_ACCOUNT' => 'Napravi novi nalog',
'L_CREDITS' => 'blagodarenje',
'L_CURRENT_VCS_ADAPTER' => 'Korisnik VCS adapter',
'L_DATA_TO_ANALYZE' => 'Podaci koji se analiziraju',
'L_DATETIME' => 'Datum / Vreme',
'L_DELETE' => 'izbrisati',
'L_DELETE_CREDENTIALS' => 'Brisanje pristupa',
'L_DELETE_FILE_TEMPLATE' => 'File Delete Template',
'L_DELETE_FLAG' => 'Brisi Zastavu',
'L_DELETE_KEY' => 'Brisanje tastera',
'L_DELETE_LANGUAGE' => 'Brisanje jezika',
'L_DELETE_LOG_ENTRY' => 'Uklonite log unos',
'L_DELETE_USER' => 'Brisanje korisnika',
'L_DELETION_SUCCESSFUL' => 'Brisanje je uspešno',
'L_DESCRIPTION' => 'opis',
'L_DONE' => 'Urađeno',
'L_DOWNLOAD' => 'Dovnload',
'L_DOWNLOADS' => 'Preuzimanja',
'L_DOWNLOAD_OF_LANGUAGE_PACKS' => 'Preuzmite jezik',
'L_DROP_FILE_HINT' => 'Projekat logo prevucite ovde za upload.',
'L_DUPLICATE' => 'duplikat',
'L_EDIT' => 'Edit',
'L_EDITED' => 'Izmenjeno',
'L_EDIT_ENTRIES' => 'Uređivanje stavki',
'L_EDIT_ENTRY' => 'Edit',
'L_EDIT_FILE_TEMPLATE' => 'File Edit Template',
'L_EDIT_FILE_TEMPLATE_X' => 'Edit file template \'%s\'',
'L_EDIT_INLINE' => 'Ovde Edit',
'L_EDIT_KEY' => 'Edit taster',
'L_EDIT_LANGUAGE' => 'Lektura',
'L_EDIT_RIGHTS' => 'prava obrade',
'L_EDIT_RIGHT_ADDED_EXPLAIN' => 'Administrator je upravo uređivačka prava za jezičku % 1 $ s (% 2 $ s) odobrio.',
'L_EDIT_RIGHT_ADDED_TO' => 'Izmena prava dodato za % s',
'L_EDIT_RIGHT_REQUESTED' => 'Korisnik %1$s zahteva uredi prava za %2$s ( % 3 $ s)',
'L_EDIT_USER' => 'Edit',
'L_EMAIL' => 'E-mail adresa',
'L_EMAIL_FOOTER' => 'Vaš %s tim',
'L_EMAIL_HEADER' => 'Pozdrav %s ,',
'L_ENTER_VCS_EXPLAIN' => 'Molimo Vas da unesete svoje korisničko ime.',
'L_ENTRIES_PER_PAGE' => 'Stavke po stranici',
'L_ERROR' => 'greška',
'L_ERRORS' => 'greške',
